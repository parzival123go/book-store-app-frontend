  ...
  return (
    <div className="max-w-lg   mx-auto md:p-6 p-3 bg-white rounded-lg shadow-md">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className=''>
        ...
        <div className="flex flex-col items-start p-3 border-2 border-gray-300 border-dashed rounded-md bg-gray-50 hover:bg-gray-100 transition-colors">
            <input 
            type="file" 
            accept="image/*" 
            ...
            <p className="mt-2 text-xs font-medium text-indigo-600">
                Selected: <span className="italic">{imageFileName}</span>
            </p>
            )}
        </div>
        </div>
